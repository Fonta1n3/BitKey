...
public func diceKey(viewController: UIViewController, userRandomness: BigInt) -> [Any] {
    ...
    if let mnemonic = BTCMnemonic.init(entropy: sha256OfData as Data!, password: password, wordListType: BTCMnemonicWordListType.english) {
        ...
        if testnetMode {
            ...
            success = saveWallet(viewController: viewController, mnemonic: "", xpub: xpub, address: bitcoinAddress, privateKey: "", publicKey: publicKey, redemptionScript: "", network: "testnet", type: "cold", index: 0, label: "", xpriv: "")
            ...
            success = saveWallet(viewController: viewController, mnemonic: "", xpub: xpub, address: bitcoinAddress, privateKey: "", publicKey: publicKey, redemptionScript: "", network: "mainnet", type: "cold", index: 0, label: "", xpriv: "")
