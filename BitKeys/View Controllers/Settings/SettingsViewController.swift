...
class SettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        if section == 0 {
            ...
            explanationLabel = UILabel(frame: CGRect(x: 10, y: 0, width: view.frame.size.width - 20, height: 70))
            ...
            explanationLabel.text = "When Hot Mode is enabled all the private keys you create will be encrypted and saved enabling effortless spending. In Cold Mode we never save your private key on the device, you will have to scan or type in the private key manually to create the signature for the transaction which can always be done with no internet connection."
