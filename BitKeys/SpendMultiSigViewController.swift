...
class SpendMultiSigViewController: UIViewController {
    ...
    let publickKeyArray = ["0315bb65cf6ded39a28d5769c4d6564c4ee3c59b264e1ad801d366014d2b5e7246", "03228ac86795acb233da7272c85b8af8f89929e0f7acffac9bbc6562b08246f47b"]
    ...
    func makeHTTPPostRequest() {
        ...
        request.httpBody = "{\"inputs\": [{\"addresses\": [\"0315bb65cf6ded39a28d5769c4d6564c4ee3c59b264e1ad801d366014d2b5e7246\", \"03228ac86795acb233da7272c85b8af8f89929e0f7acffac9bbc6562b08246f47b\"], \"script_type\" : \"multisig-2-of-2\"}], \"outputs\": [{\"addresses\" : [\"mnqygwQYj5FfBaub6QJoZoTrJ8KiQrjd8o\"], \"value\" : 1}],\"preference\": \"low\"}".data(using: .utf8)
                            ...
                            if let error = jsonAddressResult["errors"] as? NSArray {
                                ...
                                if let toSignCheck = jsonAddressResult["tosign"] as? NSArray {
                                    ...
                                    for key in self.privateKeyArray {
                                        ...
                                        for (index, transaction) in self.transactionToBeSigned.enumerated() {
